...
function createScene()
{
	...
	// 10x (5x cada lado) para criar pilares para mostrar sombras Isto é para os pilares do lado esquerdo
	// for (var i = 0; i < 5; i++)
	// {
	...
	// 	scene.add(backdrop);	
	// }
	// 10x (5x cada lado) para criar pilares para mostrar sombras Isto é para os pilares do lado direito
	// for (var i = 0; i < 5; i++)
	// {
	// 	var backdrop = new THREE.Mesh(
